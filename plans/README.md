...
- `01-irs-materials-and-summaries.md`
  The workflow document for IRS materials. Covers first-time bootstrap, nth-pass refresh, manifest creation or maintenance, downloader use, PDF download/refresh, PDF scan and widget-catalog regeneration, and summary generation.
...
- `03-gui-and-pdf-workflow.md`
  Covers the desktop app, form visibility, editing behavior, save/load flow, PDF preview/fill behavior, the separate `pdf_field_maps` methodology, and end-to-end UX validation.
...
- IRS materials plan:
  Split between a workflow doc and a specification doc. Together they govern manifest creation or maintenance, downloader behavior, source-document inventory, normalization, storage layout, summary generation, fillability scans, and generated PDF widget catalogs.
- Master JSON plan:
